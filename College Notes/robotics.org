...
** Questions
1. Generate reference frames - X - red, y - green, z - blue
* TODO Reference: JJ Craig, Introduction to Robotics: Mechanics And control, Pearson Publishing
* TODO Create the rotation matrix using roll pitch and yaw, from either projection or euler angle.
