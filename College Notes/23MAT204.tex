...
\part{Mathematics}
\label{sec:org9d19e89}
\chapter{Revision Linear Algebra}
\label{sec:org05c6dda}
...
\end{itemize}
\part{Overview}
\label{sec:org1caffe2}
\chapter{Calculating Eigenvalues and Eigenvectors}
\label{sec:orgd8c768b}
\chapter{Norms Of Vectors}
\label{sec:org87c198d}
\section{\(L_n\) norm}
\label{sec:org97a6278}
