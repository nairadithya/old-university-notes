...
\part{Mathematics}
\label{sec:org4e20e1f}
\chapter{Revision Linear Algebra}
\label{sec:orgc1ae2f7}
...
\label{sec:orgd512bf0}
\part{Overview}
\label{sec:orgd491e4c}
\chapter{Calculating Eigenvalues and Eigenvectors}
\label{sec:orgb59f3c8}
\chapter{Norms Of Vectors}
\label{sec:orgfa8034c}
\section{\(L_n\) norm}
\label{sec:org770f822}
