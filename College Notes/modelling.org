...
[[file:~/university-notes/Modelling, Simulation And Analysis/assignments/23AID201_MSA_PracticeSheet01.pdf][Practice Sheet 01]
1. For mathematical modelling, formulation of state space equation from a mathematic model, and block diagram representation follow [[file:~/university-notes/Modelling, Simulation And Analysis/textbooks/Modern Control Engineering 5th Edition.pdf][Modern Control Engineering by Ogata]] - [[pdf:~/University-Latex-Notes/Modelling, Simulation And Analysis/textbooks/Modern Control Engineering 5th Edition.pdf::24++0.00][Chapter 2]] [[pdf:~/University-Latex-Notes/Modelling, Simulation And Analysis/textbooks/Modern Control Engineering 5th Edition.pdf::40++0.00][section 2.4]] and [[pdf:~/University-Latex-Notes/Modelling, Simulation And Analysis/textbooks/Modern Control Engineering 5th Edition.pdf::74++0.00][Chapter 3(section 3.1 - 3.3)]]
