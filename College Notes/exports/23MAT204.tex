...
\part{Mathematics}
\label{sec:orga4d3a8d}
\chapter{Revision Linear Algebra}
\label{sec:org990d095}
...
\label{sec:orgb070601}
$$U_x = E(x) = \Sigma x f(x)$$
\item Variance Of Random Variable
\label{sec:org31bf29c}
