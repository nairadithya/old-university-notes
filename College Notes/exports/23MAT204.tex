...
\part{Mathematics}
\label{sec:org684f7da}
\chapter{Revision Linear Algebra}
\label{sec:org4f61d30}
...
\label{sec:org1f6051c}
$$\int_0^x f(y)dy$$
\item Mean Of Random Variable
\label{sec:org9d392d6}
$$U_x = E(x) = \Sigma x f(x)$$
\item Properties
\label{sec:org253b09c}
\begin{itemize}
\item \(f(x) \ge 0\)
