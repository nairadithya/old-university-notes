...
\part{Mathematics}
\label{sec:orge1ed255}
\chapter{Revision Linear Algebra}
\label{sec:org21451a9}
...
\part{Overview}
\label{sec:org2e9473a}
\chapter{Calculating Eigenvalues and Eigenvectors}
\label{sec:orgd59299b}
\chapter{Norms Of Vectors}
\label{sec:orgaafd938}
\section{\(L_n\) norm}
\label{sec:orgd8fef4a}
