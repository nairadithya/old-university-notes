...
\part{Mathematics}
\label{sec:org21381b9}
\chapter{Revision Linear Algebra}
\label{sec:org5cf5b11}
...
\part{Overview}
\label{sec:org0dc8af7}
\chapter{Calculating Eigenvalues and Eigenvectors}
\label{sec:org65d594e}
\chapter{Norms Of Vectors}
\label{sec:org5f5e103}
\section{\(L_n\) norm}
\label{sec:orgf92bba3}
