...
\part{Mathematics}
\label{sec:org6244666}
\chapter{Revision Linear Algebra}
\label{sec:org65bbc60}
...
\label{sec:orgc8cbf38}
$$\int_0^x f(y)dy$$
\item Mean Of Random Variable
\label{sec:org1b0295b}
$$U_x = E(x) = \Sigma x f(x)$$
\item Properties
\label{sec:orgb6563ac}
\begin{itemize}
\item \(f(x) \ge 0\)
...
\label{sec:org3041c8f}

\begin{itemize}
\item Multiple discrete random variables

Multinomial distributions, $$P(X_1 = x_{1}, X_2 = x_2, ... , X_k = x_k) = \frac{n!}{x_1! x_2! x_3! ... x_k!} p_1^{x_1}p_2^{x_2}...p_k^{x_k}$$
\end{itemize}
\end{document}
