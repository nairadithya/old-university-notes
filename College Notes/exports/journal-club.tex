...
\label{sec:org8e87e34}
\item Distributive Law
\label{sec:orgccc3e70}
\item Multiplication
\label{sec:orgc90b288}
\begin{enumerate}
\item Cancellation Law
\label{sec:org16355aa}
\item Associativity
\label{sec:org3039e7d}
\item If a<b, and c is positive then ac<bc
\label{sec:orgf7381b1}
\end{enumerate}
\end{enumerate}
\end{document}
