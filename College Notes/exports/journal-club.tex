...
\section{Exercise}
\label{sec:orgaf469ba}
\begin{enumerate}
\item Prove the identity \((a+b)^2 = a^2 + 2ab + b^2\)
\label{sec:org5dc47ae}
\item (Euclid's division lemma)
\label{sec:org87d7819}
\item Backward Induction
\label{sec:org013fa44}
...
\label{sec:org2ebef49}
\item Distributive Law
\label{sec:orga4ea9c6}
\item Multiplication
\label{sec:orgf7e0207}
\begin{enumerate}
\item Cancellation Law
\label{sec:orgde2ad85}
\item Associativity
\label{sec:org18aac3b}
\item If a<b, and c is positive then ac<bc
\label{sec:org91523ea}
\end{enumerate}
\end{enumerate}
\end{document}
