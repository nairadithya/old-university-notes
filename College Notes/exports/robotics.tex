...
\label{sec:orgc7bcbbd}
\section{Forward And Inverse Kinematics}
\label{sec:org23d88eb}
...
\label{sec:org1876354}
\begin{enumerate}
\item Question 1
\label{sec:org1e40244}
...
\label{sec:org0597f71}
\item Using Inverse Kinematics
\label{sec:org55fe4b6}
