...
\end{lemma}
\section{Exercise}
\label{sec:org6fd4fa9}
\begin{enumerate}
\item Prove the identity \((a+b)^2 = a^2 + 2ab + b^2\)
\label{sec:orgb8af9f8}
\item (Euclid's division lemma)
\label{sec:org45a72f9}
\item Backward Induction
\label{sec:org04f4a48}
...
\label{sec:org7b957b3}
\item Distributive Law
\label{sec:org7010599}
\item Multiplication
\label{sec:org2ac076d}
\begin{enumerate}
\item Cancellation Law
\label{sec:orgbe623d9}
\item Associativity
\label{sec:orgad46842}
\item If a<b, and c is positive then ac<bc
\label{sec:org895adfc}
\end{enumerate}
\end{enumerate}
\end{document}
