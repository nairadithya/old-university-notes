...
class vestigial(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "vestigial")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(500000, analog.GR_SIN_WAVE, 25000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(500000, analog.GR_SIN_WAVE, 5000, 1, 0, 0)
...
def main(top_block_cls=vestigial, options=None):
